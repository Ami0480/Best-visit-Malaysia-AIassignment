...
function showActivity(event) {
  ...
  let context = `You are a knoledge of Malaysia. Provide 3 specific about ${searchFormInput.value}things to do in Malaysia and write separate line with <br />. Start with Here are some popular activities you can enjoy in Malaysia!! with font-size:22px;. Use <div></div> each answer with <ul>,use <strong> element before ,. AmiCodes AI at the bottom with<strong> element`;
